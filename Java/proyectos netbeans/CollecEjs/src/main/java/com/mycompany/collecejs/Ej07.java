 ...
 * @author usuario
 */
public class Ej07 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ej07.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
